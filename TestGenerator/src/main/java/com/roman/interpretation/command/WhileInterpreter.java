...
import com.roman.operation.command.WhileOperator;
 ...
 */
public class WhileInterpreter extends ChainedInterpreter<CommandInterpreter> implements CommandInterpreter {
    ...
    public CommandOperator interpret(InputTestReader reader, Context context) throws ProcessException, IOException {
        ...
        whileOperator.setInstructions(instructions);
