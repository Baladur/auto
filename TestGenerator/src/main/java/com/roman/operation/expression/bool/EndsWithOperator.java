 ...
 */
public class EndsWithOperator extends TwoOperandExpression implements ExpressionOperator {
    public EndsWithOperator(ExpressionInterpreter interpreter, String leftExp, String rightExp, Context context) throws ProcessException {
        super(interpreter, leftExp, rightExp, context);
    }

    @Override
    public String evaluate(Context context) {
        return String.format("%s ends with %s", operand1.evaluate(context), operand2.evaluate(context));
    }
}
