 ...
 */
public class StartsWithOperator extends TwoOperandExpression implements ExpressionOperator {
    public StartsWithOperator(ExpressionInterpreter interpreter, String leftExp, String rightExp, Context context) throws ProcessException {
        super(interpreter, leftExp, rightExp, context);
    }

    @Override
    public String evaluate(Context context) {
        return String.format("%s starts with %s", operand1.evaluate(context), operand2.evaluate(context));
    }
}
