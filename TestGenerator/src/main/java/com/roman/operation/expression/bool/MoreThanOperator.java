 ...
 */
public class MoreThanOperator extends TwoOperandExpression implements ExpressionOperator {
    public MoreThanOperator(ExpressionInterpreter interpreter, String leftExp, String rightExp, Context context) throws ProcessException {
