 ...
 */
public class LessThanOperator extends TwoOperandExpression implements ExpressionOperator {
    public LessThanOperator(ExpressionInterpreter interpreter, String leftExp, String rightExp, Context context) throws ProcessException {
