 ...
 */
public class LessOrEqualsOperator extends TwoOperandExpression implements ExpressionOperator {
    public LessOrEqualsOperator(ExpressionInterpreter interpreter, String leftExp, String rightExp, Context context) throws ProcessException {
